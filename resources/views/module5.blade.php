                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                        ...
                        @if ($user->support === 'manual')
                            ...
                            <div class="imgbox" id="box1.3" style="display: none; margin-top: 20px">
                                <p> تستخدم أداة Render Style  لتعديل الوان المشهد قبل الاخراج 
                                    &nbsp;</p>
                                <p>يستخدم أمر Current Frame Preview لمعاينة اخراج اللقطة الحالية من المشهد &nbsp;</p>
                                <p>Render image  يستخدم لاخراج المشهد كصورة &nbsp;</p>
